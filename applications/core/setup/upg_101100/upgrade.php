...
class _Upgrade
{
	...
	public function step14()
	{
		...
		\IPS\Db::i()->update( 'core_themes', array( 'set_is_acp_default' => 0 ) );
		...
		try
		{
			...
			/* Name */
			\IPS\Lang::saveCustom( 'core', "core_theme_set_title_{$theme->id}", "4.2" );
		}
		catch( \IPS\Db\Exception $e )
		{
			/* Column does not exist, set_customized was added in 4.3, so may not yet exist */
			if( $e->getCode() != 1054 )
			{
				throw $e;
			}
