...
class _support extends \IPS\Dispatcher\Controller
{
	...
	{
		\IPS\Output::i()->output = \IPS\Theme::i()->getTemplate( 'support', 'core', 'admin' )->message( '__nulling_null_alert', 'warning' );
		return;
	}
	...
	protected function _getBlocks()
	{
		...
		$blocks['thirdparty'] = array(
			'title'		=> \IPS\Member::loggedIn()->language()->addToStack('health__thirdparty_title')
		);
