...
class _membersactivity extends \IPS\Dispatcher\Controller
{
	...
	protected function manage()
	{
		...
		if( $start AND $end )
		{
			...
			$table->extraHtml = \IPS\Theme::i()->getTemplate( 'stats' )->tableheader( $start, $end, $count, "member_activity_results" );
		}
		...
		\IPS\Output::i()->output = \IPS\Theme::i()->getTemplate( 'stats' )->memberactivity( $formHtml, $count, $table );
	}
}