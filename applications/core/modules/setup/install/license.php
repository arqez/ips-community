...
class _license extends \IPS\Dispatcher\Controller
{
	...
	public function manage()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'lkey', 'N u l l J u n g l e . c o m', TRUE, array( 'size' => 50 ), function( $val )
		{
		...
		}, NULL, str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>')) );
